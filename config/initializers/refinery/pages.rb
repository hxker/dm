...
Refinery::Pages.configure do |config|
  ...
  # config.friendly_id_reserved_words = ["index", "new", "session", "login", "logout", "users", "refinery", "admin", "images", "wymiframe", "competition", "competitions", "shows", "news", "password", "edit", "cancel", "confirmation", "unlock", "captcha", "accounts", "register", "user", "preview", "profile", "passwd", "mobile", "notification", "comp", "likes", "test", "admins", "events", "teams", "scores", "organizers", "audit", "schedules", "referees", "roles", "districts", "kindeditor", "upload", "filemanager"]
