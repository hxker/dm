...
//            }
            ...
            for (var i = 0; i < placeData.length; i++) {
                for (var j = 0; j < placeData[i].length; j++) {
                    var r = s.paper.rect(placeData[i][j].x + 10, placeData[i][j].y + 10, 100, 40, 0).attr({
                        fill: '#f5f5f5',
                        stroke: '#aaa',
                        strokeWidth: '1'
                    });
                    ...
                    if (roundData[i][j].length > 1) {
                        var lr = s.paper.rect(placeData[i][j].x + 20, placeData[i][j].y + 20, 20, 20, 0).attr({
                            fill: '#eee'
                        });

                        var rr = s.paper.rect(placeData[i][j].x + 80, placeData[i][j].y + 20, 20, 20, 0).attr({
                            fill: '#eee'
                        });

                        var lt = s.paper.text(placeData[i][j].x + 24, placeData[i][j].y + 34, roundData[i][j][0]);

                        var rt = s.paper.text(placeData[i][j].x + 84, placeData[i][j].y + 34, roundData[i][j][1]);

                        var t = s.paper.text(placeData[i][j].x + 54, placeData[i][j].y + 34, 'VS');
                    } else {
                        var r = s.paper.rect(placeData[i][j].x + 50, placeData[i][j].y + 20, 20, 20, 0).attr({
                            fill: '#eee'
                        });
                        var t = s.paper.text(placeData[i][j].x + 54, placeData[i][j].y + 34, roundData[i][j][0]);
                    }
                }
            }
        }
